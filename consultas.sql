...
--Consultar quais anuncios que est�o relacionados a compras acima de 100 reais
...
SELECT j.nome FROM tab_jornalista j WHERE supervisor = (SELECT REF(d) FROM tab_diretor_executivo d WHERE d.id = 1);
